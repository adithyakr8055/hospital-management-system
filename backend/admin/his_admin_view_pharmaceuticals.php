                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <?php
                                        /*
                                         * Get details of pharmaceuticals with quantity above the average
                                         */
                                        $ret = "SELECT p.phar_name, p.phar_bcode, v.v_name, p.phar_cat, p.phar_qty FROM his_pharmaceuticals AS p
                                            JOIN 
